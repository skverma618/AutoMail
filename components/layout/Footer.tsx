    ...
    return (
        <footer className='w-full py-3 border-t flex items-center justify-around  mt-auto'>
            ...
            <div className='Icons flex flex-row gap-3'>
                <Link href="https://github.com/skverma618/AutoMail" className='cursor-pointer' target='_blank'>
                    <Icon icon="akar-icons:github-fill" fontSize={26} />

                </Link>
                {/* <Link href="https://twitter.com/skverma618" className='cursor-pointer' target='_blank'>
